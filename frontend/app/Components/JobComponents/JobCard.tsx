  ...
  return (
    ...
    >
      <View
        ...
        accessible={true}
        accessibilityLabel={`Job posting for ${title} at ${company}`}
      >
          ...
          <View style={styles.card}>
              ...
              {(job_phone || job_email || job_website) && (
                <View>
                  {job_phone && (
                    <TouchableOpacity
                      style={styles.row}
                      onPress={() => Linking.openURL(`tel:${job_phone}`)}
                    >
                  ...
                  {job_email && (
                    <TouchableOpacity
                      style={styles.row}
                      onPress={() => Linking.openURL(`mailto:${job_email}`)}
                    >
            ...
            <View style={styles.buttonGroup}>
              ...
              >
                <Ionicons
                  name={
                    savedJobs.includes(jobId) ? "bookmark" : "bookmark-outline"
                  }
                  size={30}
                  color="#000"
                />
