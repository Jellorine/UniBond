          ...
          {job.job_phone && (
            <View style={styles.detailRow}>
              ...
              <Text
                ...
                onPress={() => Linking.openURL(`tel:${job.job_phone}`)}
              >
                {job.job_phone}
              </Text>
            </View>
          ...
          {job.job_email && (
            <View style={styles.detailRow}>
              ...
              <Text
                ...
                onPress={() => Linking.openURL(`mailto:${job.job_email}`)}
              >
                {job.job_email}
              </Text>
            </View>
          ...
          {job.job_website && (
            <View style={styles.detailRow}>
              ...
              <Text
                ...
                onPress={() => {
                  const fullUrl = job.job_website.startsWith("http")
                    ? job.job_website
                    : `https://${job.job_website}`;
